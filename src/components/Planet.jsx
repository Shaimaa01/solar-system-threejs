...
const Planet = (scene, planetInfo) => {
  ...
  const material = new THREE.MeshPhongMaterial({
    ...
    shininess: planetInfo.name === 'Earth' ? 30 : 5,
    specular: planetInfo.name === 'Earth' ? 0x111111 : 0x080808
  });
  ...
  mesh.userData = {
    ...
    rotationSpeed: 0.005 + Math.random() * 0.01 // Slower rotation
  };
  ...
  if (planetInfo.name === 'Earth') {
    const moonGeometry = new THREE.SphereGeometry(0.2, 8, 8); // Lower detail
